    ...
    return (
        <>
            <form onSubmit={handleSubmit}>
                <div className={"bg-primary flex flex-col justify-around mx-auto md:mx-20 rounded-lg space-y-4 px-24 py-20 md:my-20 max-w-4xl shadow-xl"}>
                    ...
                    <div className={"ml-3 font-poppins"}>
                        ...
                        <div className={"pt-4"}>
                            <div className={"text-2xl mb-1"}>Combien de KM avez-vous couru?</div>
                            <input min={"0"} name={"distance"} step={"0.1"} type="number" className={"py-2 px-6 my-2 rounded-lg text-2xl"} placeholder={"Nombre"}/>
                        </div>
                        <div className={"pt-4"}>
                            <div className={"text-2xl mb-1"}>Quelle est la date de votre course?</div>
                            <input name={"date"} type="date" className={"py-2 px-6 my-2 rounded-lg text-2xl mb-8"} placeholder={"Nombre"}/>
                        </div>
                    </div>
                    <input className={"bg-white ml-3 px-8 rounded-lg py-4 px-6 text-2xl w-max font-poppins font-bold uppercase"} type={"submit"}/>
                </div>
