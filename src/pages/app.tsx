  ...
  return (
    <>
      ...
      {isOpen ? (
        <div
          className={
            "inset-0 md:bg-hero-i-like-food-100 absolute z-10 bg-dark bg-opacity-80 flex justify-center"
          }
        >
          <Form
            mutate={mutate}
      ...
      <div className={" z-4 container mx-auto md:mt-10 md:w-3/4 flex flex-col"}>
        ...
        >
          <div className={"md:mb-10 mb-5 self-start flex flex-row space-x-2"}>
            <HomeIcon
              onClick={() => router.push("/")}
              className={"w-8 md:w-12 text-white mb-5"}
            />
          </div>
          <div
            className={
          ...
          >
            ...
            <div
              onClick={toggleModal}
              className={
                "cursor-pointer md:text-xl text-sm mb-14 self-center hover:shadow hover:text-white hover:bg-primary md:self-center w-max h-max text-dark uppercase bg-secondary md:py-4 py-2 px-4 rounded-lg  font-bold font-poppins flex items-center"
              }
            >
