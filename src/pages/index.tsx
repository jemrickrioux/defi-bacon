...
const Chart = dynamic(() => import("../components/DailyDistanceChart"), {
  loading: () => <p>Loading ...</p>,
  ssr: false,
});
      ...
      <div className={"container mx-auto overflow-hidden"}>
        <div className={"grid"}>
          <div className={"flex flex-col md:my-20 my-4 md:mx-20 mx-6"}>
            ...
            <p className={"md:text-2xl text-lg mt-4 max-w-xl md:mt-12"}>
              À chaque tranche de 10$ nous allons courir 1KM à la mémoire de
              Maxime Papillon.
            </p>
            <div
              className={
                "flex md:flex-row flex-col md:my-14 my-8 md:space-x-3 md:space-y-0 space-y-2"
              }
            >
              <div
                className={
                  "w-max h-max hover:shadow py-4 px-6 rounded-lg cursor-pointer md:text-xl  bg-primary text-white uppercase font-bold font-rubik"
                }
              >
                <a
                  target={"__blank__"}
              ...
              <div
                className={
                  "w-max h-max hover:shadow py-4 px-6 rounded-lg cursor-pointer md:text-xl bg-dark text-white uppercase font-bold font-rubik"
                }
              >
                <Link href={"/app"}>Contribuer à la course</Link>
              </div>
            </div>
            <div className={"flex flex-col space-y-2 max-w-4xl mb-20"}>
