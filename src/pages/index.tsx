...
const Home: NextPage = () => {
  ...
  return (
    <>
      ...
      <div className={"container h-screen mx-auto overflow-hidden font-sans"}>
        <div className={"grid"}>
            <div className={"flex flex-col md:py-20 py-6 my-10 md:my-40 mx-6"}>
                ...
                <p className={"md:text-2xl text-lg mt-4"}>À chaque tranche de 10$ nous allons courir 1 KM en la mémoire de Maxime Papillon.</p>
